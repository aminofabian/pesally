...
// const SignUp = () => {
//   return (
//     <div className="flex flex-col max-w-md p-6 rounded-md sm:p-10 mx-auto border mt-5">
...
// 			</div>
//             <div>
// 				<label htmlFor="text" className="block mb-2 text-sm">Name</label>
// 				<input type="email" name="email" id="email" placeholder="John Doe" className="w-full px-3 py-2 border rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800" />
// 			</div>
// 			<div>
